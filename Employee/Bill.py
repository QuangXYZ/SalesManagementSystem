...
class bill_window:
    def __init__(self, top=None):
        ...
        self.entry4 = ttk.Entry(bill_root)
    ...
    def show_qty(self, Event):
        ...
        self.qty_label = Label(bill_root)
    ...
    def wel_bill(self):
        ...
        self.num_message = Text(bill_root)
        ...
        self.bill_message = Text(bill_root)
        ...
        self.bill_date_message = Text(bill_root)
    ...
    def chooseTypeOfCus(self):
        windowChooseTypeOfCus = Toplevel(bill_root)
        x = int(bill_root.winfo_screenwidth() / 2 - 500 / 2)
            ...
            #     messagebox.showerror("Oops!", "Please enter a valid number.", parent=bill_root)
                ...
                if strr.find('Total')==-1:
                    ...
                    for name, qty in self.cart.dictionary.items():
                        ...
                        db.commit()
                    messagebox.showinfo("Success!!", "Bill Generated", parent=bill_root)
...
pageBill = bill_window(bill_root)
bill_root.mainloop()